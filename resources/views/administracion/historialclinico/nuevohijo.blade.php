...
@section('content')
    ...
    <form id="frmnuevohistorialclinico" action="{{route('crearhistorialclinico',$idFranquicia)}}"  enctype="multipart/form-data" method="POST" onsubmit="btnSubmit.disabled = true;" >
      @csrf
      @if(isset($idContrato))
        <input type="text" name="idcontratopadre" hidden value="{{$idcontratopadre}}">
      @endif
      {{info($idContrato)}}
      {{info($idcontratopadre)}}
        ...
        <div class="row">
          <div class="col-3">
            <div class="form-group">
              ...
              <input type="text" name="entrecalles" class="form-control {!! $errors->first('entrecalles','is-invalid')!!}"  placeholder="Entre calles"  readonly
                     value="{{ $contratos[0]->entrecalles}}">
          ...
          <div class="col-2">
           ...
           <div class="col-2">
            <div class="form-group">
              ...
              <input type="text" name="correo" class="form-control {!! $errors->first('correo','is-invalid')!!}"  placeholder="Correo electronico" readonly value="{{ $contratos[0]->correo}}">
           ...
           <div class="col-2">
                 <label>Archivos:</label>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="principal" id="principal"  value="1" {{old('principal') == '1' ? 'checked' : ''}}>
                            <label class="custom-control-label" for="principal">Duplicar documentos</label>
                        </div>
                </div>
         </div>
         <div class="row">
          <div class="col-3">
            <div class="form-group">
              ...
              <input type="file" name="fotoine" class="form-control-file  {!! $errors->first('fotoine','is-invalid')!!}" accept="image/jpg">
          ...
          <div class="col-2">
            <div class="form-group">
              ...
              <input type="file" name="fotoineatras" class="form-control-file  {!! $errors->first('fotoineatras','is-invalid')!!}" accept="image/jpg">
          ...
          <div class="col-2">
            <div class="form-group">
              <label>Pagare:</label>
              <input type="file" name="pagare" class="form-control-file  {!! $errors->first('pagare','is-invalid')!!}" accept="image/jpg">
          ...
          <div class="col-2">
            <div class="form-group">
              ...
              <input type="file" name="fotocasa" class="form-control-file  {!! $errors->first('fotocasa','is-invalid')!!}" accept="image/jpg">
          ...
          <div class="col-3">
            <div class="form-group">
              ...
              <input type="file" name="comprobantedomicilio" class="form-control-file  {!! $errors->first('comprobantedomicilio','is-invalid')!!}" accept="image/jpg">
            ...
            <div class="franquicia">
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label>Edad</label>
                            <input type="text" name="edad" class="form-control {!! $errors->first('edad','is-invalid')!!}"  placeholder="Edad" value="{{ old('edad')}}">
                    ...
                    <div class="col-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="diagnostico" class="form-control {!! $errors->first('diagnostico','is-invalid')!!}"  placeholder="Diagnostico" value="{{ old('diagnostico') }}">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="ocupacion" class="form-control {!! $errors->first('ocupacion','is-invalid')!!}"  placeholder="Ocupacion" value="{{ old('ocupacion') }}">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="diabetes" class="form-control {!! $errors->first('diabetes','is-invalid')!!}"  placeholder="Diabetes" value="{{ old('diabetes') }}">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="hipertension" class="form-control {!! $errors->first('hipertension','is-invalid')!!}"  placeholder="Hipertension"
                                   value="{{ old('hipertension') }}">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input {!! $errors->first('ardor','is-invalid')!!}" name="dolor" id="dolores"
                                   value="1" {{old('dolor') == '1' ? 'checked' : ''}}>
                            <label class="custom-control-label" for="dolores">Dolor de cabeza</label>
                            {!! $errors->first('ardor','<div class="invalid-feedback">Elegir al menos una molestia</div>')!!}
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="ardor" id="ardores"  value="1" {{old('ardor') == '1' ? 'checked' : ''}}>
                            <label class="custom-control-label" for="ardores">Ardor de los ojos</label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="golpe" id="golpes"  value="1" {{old('golpe') == '1' ? 'checked' : ''}}>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="otroM" id="customCheck4"  value="1" {{old('otroM') == '1' ? 'checked' : ''}}>
                                <label class="custom-control-label" for="customCheck4">Otro</label>
                            </div>
                            <input type="text" name="molestia" class="form-control {!! $errors->first('molestia','is-invalid')!!}"  placeholder="Otro" value="{{ old('molestia') }}">
                            {!! $errors->first('molestia','<div class="invalid-feedback">Solo permitido si eliges la opción de otro, Elegir al menos una molestia</div>')!!}
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            <label>Ultimo examen</label>
                            <input type="date" name="ultimoexamen" class="form-control {!! $errors->first('ultimoexamen','is-invalid')!!}"  placeholder="Ultimo examen"
                                   value="{{ old('ultimoexamen') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <select class="custom-select {!! $errors->first('paquete','is-invalid')!!}" name="paquete" onchange="paqueteSeleccionado(this)">
                            @if(count($paquetes) > 0)
                                <option selected value = 0>Seleccionar</option>
                                @foreach($paquetes as $paquete)
                                        <option value="{{$paquete->id}}" {{old('paquete') == $paquete->id ? 'selected' : ''}}>{{$paquete->nombre}}</option>
                                @endforeach
                            @else
                                <option selected>Sin registros</option>
                            @endif
                        </select>
                        {!! $errors->first('paquete','<div class="invalid-feedback">Elegir un paquete, campo obligatorio </div>')!!}
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        ...
                        <div class="form-check">
                            ...
                            {!! $errors->first('motro','<div class="invalid-feedback">solo si eliges la opción otro, elegir su precio también</div>')!!}
                        </div>
                        </div>
                        <div class="col-3">
                           <div class="form-check">
                            <input type="number" name="costomaterial" class="form-control {!! $errors->first('costomaterial','is-invalid')!!}" min="0"  placeholder="Precio/Costo"
                                   value="{{ old('ccostomaterialosto') }}">
                            {!! $errors->first('costomaterial','<div class="invalid-feedback">solo si eliges la opción otro.</div>')!!}
                           </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input {!! $errors->first('fotocromatico','is-invalid')!!}" name="fotocromatico" id="customCheck9"
                    ...
                    <div class="col-2">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input {!! $errors->first('ar','is-invalid')!!}" name="ar" id="customCheck10"
                                   value="1" checked {{old('ar') == '1' ? 'checked' : ''}}>
                    ...
                    <div class="col-2">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input   {!! $errors->first('tinte','is-invalid')!!}" name="tinte"  id="customCheck11"
                                   value="1" {{old('tinte') == '1' ? 'checked' : ''}}>
                    ...
                    <div class="col-2">
                        <div class="custom-control custom-checkbox">
                            <input type="text" name="otroT" class="form-control {!! $errors->first('otroT','is-invalid')!!}" min="0"  placeholder="Otro" value="{{ old('otro2') }}">
                            {!! $errors->first('otroT','<div class="invalid-feedback">Solo permitido si eliges la opción de otro.</div>')!!}
                        </div>
                        </div>
                        <div class="col-2">
                           <div class="custom-control custom-checkbox">
                            <input type="number" name="costoT" class="form-control {!! $errors->first('costoT','is-invalid')!!}" min="0"  placeholder="Precio/Costo" value="{{ old('precio2') }}">
                ...
                <div class="row">
                    <div class="col-4">
                        <a href="{{route('listacontrato',$idFranquicia)}}" class="btn btn-outline-success btn-block">@lang('mensajes.regresar')</a>
                    </div>
                    <div class="col-8">
